...
function SideBar() {
  const user = {};
  return (
    <div className="fixed h-screen w-1/6 flex flex-col justify-between border-[#00000011] border-r-2">
      <div className="flex gap-10 flex-col">
        <div className=" border-[#00000011] border-b-2 px-5 py-3 flex justify-between items-center ">
